    ...
    return (
        <tr className={`border-y border-y-border`}>
            ...
            <td className={`flex gap-3 px-2 py-4 text-start`}>
                <button className={`border border-primary rounded-sm cursor-pointer hover:border-accent hover:text-accent transition-colors duration-200 text-primary font-medium px-4 min-w-28 w-28 py-1.5`} type="button">{!isPublished ? `Published` : `Unpublished`}</button>
